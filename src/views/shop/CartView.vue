...
const notification = {
  ...
  button1: { text: t('cart.goShopping'), route: 'home' },
  button2: { text: '', route: '' }
}
...
<template>
  ...
  <div v-else>
    <h1 class="mb-4 mt-5 text-xl font-semibold leading-none tracking-tight text-gray-900">{{ t('cart.title') }}</h1>
      ...
      <div class="flex lg:space-x-4">
        <div class="flex-1 mt-10 space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
          <p class="flex items-center">
            ...
            <span class="text-xl font-semibold text-gray-900 ml-1">{{ t('cart.orderSummary') }}</span>
          </p>
          <div>
          ...
          <div class="space-y-4">
            <div class="space-y-2">
              <dl class="flex items-center justify-between gap-4">
                <dt class="text-base font-normal text-gray-500">{{ t('cart.amount') }}</dt>
              ...
              <dl v-if="coupon.discount > 0" class="flex items-center justify-between gap-4">
                <dt class="text-base font-normal text-gray-500">{{ t('common.savings') }} ({{ coupon.discountDescription }})</dt>
            ...
            <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2">
              <dt class="text-base font-bold text-gray-900">{{ t('common.total') }}</dt>
          ...
          <div class="pt-6">
            ...
            >
              ...
              <span class="ml-1">{{ t('common.checkout') }}</span>
            </button>
          </div>
        </div>
